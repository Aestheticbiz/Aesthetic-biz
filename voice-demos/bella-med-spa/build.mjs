...
sec.trust = () => `
  <section class="trust s-base">
    <div class="shell trust__in">
      ${D.trust.map((t) => `<div class="trust__item">
        ${icon(t.icon)}
...
<main id="top">
  <section class="hero">
    ...
    <div class="shell hero__in">
      ...
      <div class="proofrow">
        <span><i aria-hidden="true">&#9733;&#9733;&#9733;&#9733;&#9733;</i> <b>${esc(D.proof.rating)}</b> from ${esc(D.proof.reviewCount)} ${esc(D.proof.reviewSource)} reviews</span>
        ${D.proof.award ? `<span><b>${esc(D.proof.award)}</b></span>` : ''}
        <span class="hide-sm">${D.locations.items.length} locations</span>
      </div>
