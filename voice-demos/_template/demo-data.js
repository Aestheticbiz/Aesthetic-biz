...
export default {
  ...
  sandy: {
    ...
    /* ── What she actually SAYS about each treatment ─────────────────
       Without this she falls back on the only structured data she has —
       appointment length — and answers "Bella Tox is forty-five minutes,
       Mini Tox is thirty". True, useless, and it makes the practice sound
       like a car park.

       Two or three sentences each: what it is, what it involves, who
       tends to choose it. No prices, no outcome promises, no "safe", no
       durations unless asked. A real client would write or approve these;
       these are drafted from the practice's own service descriptions and
       from what the treatment plainly is. */
    talkingPoints: {
