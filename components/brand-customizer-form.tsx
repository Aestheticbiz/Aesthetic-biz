...
type Props = {
  /** Extra actions under the form (e.g. Explore site) */
  footer?: React.ReactNode;
};

export function BrandCustomizerForm({ footer }: Props) {
  ...
  return (
    <div className="brand-form">
      <p className="brand-form-note">
        Changes apply to the <strong>whole demo site</strong> in this browser (saved locally) —
        not just this page. Reset anytime.
      </p>
      ...
      <div className="brand-form-actions">
        <button type="button" className="btn btn-outline-dark btn-sm" onClick={resetTheme}>
          Reset demo brand
        </button>
        {footer}
      </div>
